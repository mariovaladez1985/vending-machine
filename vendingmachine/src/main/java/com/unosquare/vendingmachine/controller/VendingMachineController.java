...
public class VendingMachineController {
	...
	public String loadProductsList(@RequestParam("productsFile") MultipartFile file, ModelMap modelMap) {
	...
	public String addToBalance(@RequestParam("denomination") String strDenominacion, ModelMap modelMap) {
		...
		try
		{
			...
			vendingMachine.setCashBalance(vendingMachine.getCashBalance() + denomination.getValue());
	...
	@RequestMapping(value = "/endTransaction")
	@ResponseBody
